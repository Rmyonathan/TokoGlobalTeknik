...
class ChartOfAccountsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $accounts = [
            ...
            ['code' => '1104-1-QRIS', 'name' => 'Bank Mandiri - QRIS', 'type' => 'A', 'parent' => '1104-1'],
            ['code' => '1104-1-EDC', 'name' => 'Bank Mandiri - EDC', 'type' => 'A', 'parent' => '1104-1'],
            ['code' => '1104-1-GIRO', 'name' => 'Bank Mandiri - Giro', 'type' => 'A', 'parent' => '1104-1'],
            ['code' => '1104-2', 'name' => 'Bank BNI', 'type' => 'A', 'parent' => '1104'],
            ['code' => '1104-2-QRIS', 'name' => 'Bank BNI - QRIS', 'type' => 'A', 'parent' => '1104-2'],
            ['code' => '1104-2-EDC', 'name' => 'Bank BNI - EDC', 'type' => 'A', 'parent' => '1104-2'],
            ['code' => '1104-2-GIRO', 'name' => 'Bank BNI - Giro', 'type' => 'A', 'parent' => '1104-2'],
            ['code' => '1104-3', 'name' => 'Bank BRI', 'type' => 'A', 'parent' => '1104'],
            ['code' => '1104-3-QRIS', 'name' => 'Bank BRI - QRIS', 'type' => 'A', 'parent' => '1104-3'],
            ['code' => '1104-3-EDC', 'name' => 'Bank BRI - EDC', 'type' => 'A', 'parent' => '1104-3'],
            ['code' => '1104-3-GIRO', 'name' => 'Bank BRI - Giro', 'type' => 'A', 'parent' => '1104-3'],
            ['code' => '1104-4', 'name' => 'Bank BCA', 'type' => 'A', 'parent' => '1104'],
            ['code' => '1104-4-QRIS', 'name' => 'Bank BCA - QRIS', 'type' => 'A', 'parent' => '1104-4'],
            ['code' => '1104-4-EDC', 'name' => 'Bank BCA - EDC', 'type' => 'A', 'parent' => '1104-4'],
            ['code' => '1104-4-GIRO', 'name' => 'Bank BCA - Giro', 'type' => 'A', 'parent' => '1104-4'],
